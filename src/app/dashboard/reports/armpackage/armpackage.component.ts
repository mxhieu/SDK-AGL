...
@Component({
	selector: 'app-armpackage',
	templateUrl: './armpackage.component.html',
	styleUrls: ['../report.component.scss']
})
export class ArmPackageComponent implements OnInit, OnDestroy {
	chart: AmChart;
  ...
  appid: any;
	...
	doAnalysis() {
      ...
      'app_id': this.appid,
		...
		this.service.armPackageAnalysis(params, data => {
			this.data = [];
    ...
    var params = {
		...
		this.service.armPackageChartAnalysis(params, data => {
			this.makeChart(data);
		});
	}
