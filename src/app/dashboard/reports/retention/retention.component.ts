...
export class RetentionComponent implements OnInit, OnDestroy {
	...
	constructor(
		...
		this.header = [
			...
			{ id: 'rr1_num', name: 'RR1', is_search: 1, st_col: 'rr1_num', st_type: 1 },
			{ id: 'rr3_num', name: 'RR3', is_search: 1, st_col: 'rr3_num', st_type: 1 },
			{ id: 'rr7_num', name: 'RR7', is_search: 1, st_col: 'rr7_num', st_type: 1 },
			{ id: 'rr15_num', name: 'RR15', is_search: 1, st_col: 'rr15_num', st_type: 1 },
			{ id: 'rr30_num', name: 'RR30', is_search: 1, st_col: 'rr30_num', st_type: 1 },
