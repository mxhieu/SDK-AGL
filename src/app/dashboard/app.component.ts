...
export class AppComponent implements OnInit {
  ...
  constructor(_rout: Router, _conf: ConfigService, _conn: ConnectService) { 
    ...
    this.header = [{id: 'name', name: 'Name', is_search: 1}, {id: '_id', name: 'Appid', is_search: 1}, {id: 'platform', name: 'Platform', is_search: 1}, {id: 'categories', name: 'Categories', is_search: 1}, {id: 'created_at', name: 'Created time'}, {id: 'status', name: 'Status'}];
