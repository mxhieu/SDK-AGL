...
var AdsPerformanceComponent = /** @class */ (function (_super) {
    ...
    AdsPerformanceComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./ads-performance.component.scss */ "./src/app/dashboard/reports/ads-performance/ads-performance.component.scss")]
        }),
        __metadata("design:paramtypes", [_service_group_service__WEBPACK_IMPORTED_MODULE_3__["GroupService"], _service_campaign_service__WEBPACK_IMPORTED_MODULE_2__["CampaignService"]])
    ], AdsPerformanceComponent);
...
/***/ "./src/app/dashboard/reports/ads-report/ads-report.component.scss":
/*!************************************************************************!*\
  !*** ./src/app/dashboard/reports/ads-report/ads-report.component.scss ***!
  \************************************************************************/
/*! no static exports found */
...
var AdsReportComponent = /** @class */ (function (_super) {
    ...
    AdsReportComponent.prototype.getFacebookAd = function () {
        ...
        var params = (_a = {
            ...
            _a['search_' + this.search.field] = this.search.term,
            _a);
        this.service.getAdsReport(params, function (data) { _this.facebookAds = data; console.log(data); });
        var _a;
    };
    ...
    AdsReportComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./ads-report.component.scss */ "./src/app/dashboard/reports/ads-report/ads-report.component.scss")]
        }),
        __metadata("design:paramtypes", [_service_group_service__WEBPACK_IMPORTED_MODULE_3__["GroupService"], _service_campaign_service__WEBPACK_IMPORTED_MODULE_2__["CampaignService"]])
    ], AdsReportComponent);
...
var ArmComponent = /** @class */ (function () {
    function ArmComponent(service, AmCharts) {
        this.service = service;
    ...
    ArmComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./arm.component.scss */ "./src/app/dashboard/reports/arm/arm.component.scss")]
        }),
...
var ArmpdComponent = /** @class */ (function () {
    function ArmpdComponent(service, AmCharts) {
        this.service = service;
        this.AmCharts = AmCharts;
        this.dTo = new Date();
        this.dMax = new Date();
    ...
    ArmpdComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-armpd',
            styles: [__webpack_require__(/*! ./armpd.component.scss */ "./src/app/dashboard/reports/armpd/armpd.component.scss")],
            template: __webpack_require__(/*! ./armpd.component.html */ "./src/app/dashboard/reports/armpd/armpd.component.html")
        }),
        __metadata("design:paramtypes", [_service_report_service__WEBPACK_IMPORTED_MODULE_2__["ReportService"], _amcharts_amcharts3_angular__WEBPACK_IMPORTED_MODULE_1__["AmChartsService"]])
    ], ArmpdComponent);
...
var CardComponent = /** @class */ (function () {
    ...
    CardComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./card.component.scss */ "./src/app/dashboard/reports/card/card.component.scss")]
        }),
        __metadata("design:paramtypes", [_service_report_service__WEBPACK_IMPORTED_MODULE_1__["ReportService"], _amcharts_amcharts3_angular__WEBPACK_IMPORTED_MODULE_2__["AmChartsService"]])
    ], CardComponent);
...
/***/ "./src/app/dashboard/reports/cohort/cohort.component.scss":
/*!****************************************************************!*\
  !*** ./src/app/dashboard/reports/cohort/cohort.component.scss ***!
  \****************************************************************/
/*! no static exports found */
...
var CohortComponent = /** @class */ (function () {
    ...
    CohortComponent.prototype.osPickerChanged = function (event) {
        ...
        if (event.id == '-1')
            ...
            for (var _b = 0, _c = this.versions; _b < _c.length; _b++) {
                var v = _c[_b];
                if (v.os == event.id)
                    this.versionDisplay.push(v);
            }
    ...
    CohortComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-cohort',
            styles: [__webpack_require__(/*! ./cohort.component.scss */ "./src/app/dashboard/reports/cohort/cohort.component.scss")],
...
/***/ "./src/app/dashboard/reports/roi/roi.component.scss":
/*!**********************************************************!*\
  !*** ./src/app/dashboard/reports/roi/roi.component.scss ***!
  \**********************************************************/
/*! no static exports found */
...
var RoiComponent = /** @class */ (function () {
    function RoiComponent(service, AmCharts) {
        this.service = service;
        this.AmCharts = AmCharts;
        this.dTo = new Date();
        this.dMax = new Date();
    ...
    RoiComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./roi.component.scss */ "./src/app/dashboard/reports/roi/roi.component.scss")]
        }),
        __metadata("design:paramtypes", [_service_report_service__WEBPACK_IMPORTED_MODULE_1__["ReportService"], _amcharts_amcharts3_angular__WEBPACK_IMPORTED_MODULE_2__["AmChartsService"]])
    ], RoiComponent);
    return RoiComponent;
