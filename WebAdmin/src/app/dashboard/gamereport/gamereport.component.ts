 ...
 public lineChartData: Array<any> = [
	...
	constructor(private conf: ConfigService, private service: Service) {
		...
		this.header = [
			...
			{ id: 'source', name: 'A1', is_search: 1, st_col: 'source', st_type: 1 },
			{ id: 'os', name: 'A7', is_search: 1, st_col: 'os', st_type: 1 },
			{ id: 'install', name: 'A30', is_search: 1, st_col: 'install', st_type: 1 },
			{ id: 'nru', name: 'GG Admob', is_search: 1, st_col: 'nru', st_type: 1 },
			{ id: 'rr3', name: 'Agency', is_search: 1, st_col: 'rr3', st_type: 1 },
			{ id: 'pu1', name: 'Organic', is_search: 1, st_col: 'pu1', st_type: 1 },
			{ id: 'pu3', name: 'Mainsite', is_search: 1, st_col: 'pu3', st_type: 1 },
			{ id: 'pu7', name: 'GG SEM', is_search: 1, st_col: 'pu7', st_type: 1 },
			{ id: 'pu14', name: 'FBAds', is_search: 1, st_col: 'pu14', st_type: 1 },
			{ id: 'pu21', name: 'Others', is_search: 1, st_col: 'pu21', st_type: 1 },
			{ id: 'pu30', name: 'Total', is_search: 1, st_col: 'pu30', st_type: 1 },
		];
		this.doAnalysis();
		this.getSources();
	}
	...
	doAnalysis() {
		...
		this.service.get(this.conf.API_REPORT_GAME, params,
			data => {
