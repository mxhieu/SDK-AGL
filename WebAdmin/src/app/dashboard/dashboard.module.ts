...
@NgModule({
  ...
  declarations: [
    ...
    RoiComponent, RoipdComponent, SourceslistComponent, MetricComponent, CohortComponent, CampaignComponent, AdsComponent, KpireportComponent, AdsPerformanceComponent]
})
